...
def demo1():
    pred_train_dirpath = Path('../../../view_synthesis/research/010_SameViewDenseFlow/runs/training/train0014')
    database_dirpath = Path('../../../../databases/N3DV/data')
    dense_model_dirpath = Path('../../../view_synthesis/research/003_Kplanes/runs/training/train0015')
