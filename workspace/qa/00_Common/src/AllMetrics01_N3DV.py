...
def run_all_qa(pred_train_dirpath: Path, database_dirpath: Path, dense_model_dirpath: Path, resolution_suffix: str,
    ...
    frame_metric_filepaths = [
        # this_filepath.parent / '../../01_RMSE/src/RMSE01_N3DV.py',
        # this_filepath.parent / '../../02_PSNR/src/PSNR01_N3DV.py',
        # this_filepath.parent / '../../03_SSIM/src/SSIM01_N3DV.py',
        # this_filepath.parent / '../../04_LPIPS/src/LPIPS01_N3DV.py',
        # this_filepath.parent / '../../05_VMAF/src/VMAF01_N3DV.py',
        ...
        # this_filepath.parent / '../../05_VMAF/src/VMAF11_N3DV.py',
        this_filepath.parent / '../../11_DepthRMSE/src/DepthRMSE11_N3DV.py',
        this_filepath.parent / '../../12_DepthMAE/src/DepthMAE11_N3DV.py',
        this_filepath.parent / '../../13_DepthSROCC/src/DepthSROCC11_N3DV.py',
    ]
...
def demo1():
    pred_train_dirpath = Path('../../../view_synthesis/research/100CMMRF_KAP/runs/training/train0014')
    database_dirpath = Path('../../../../databases/N3DV/data')
    gt_depth_dirpath = Path('../../../view_synthesis/research/003_Kplanes/runs/training/train0015')
