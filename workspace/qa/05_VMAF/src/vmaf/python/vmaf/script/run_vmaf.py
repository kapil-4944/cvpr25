...
def python_hook(ref_file: str, dis_file: str, *, fmt: str, width: int, height: int, model_path: str = None,
                out_fmt: str = None, pool_method: str = None, show_local_explanation: bool = False,
                phone_model: bool = False, enable_conf_interval: bool = False, save_plot_dir: str = None):
    ...
    if out_fmt == 'xml':
        # print(result.to_xml())
        return_val = result.to_xml()
    elif out_fmt == 'json':
        # print(result.to_json())
        return_val = result.to_json()
    else: # None or 'text'
        # print(str(result))
