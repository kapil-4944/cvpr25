...
if __name__ == "__main__":
    ...
    #
    # time.sleep(5)
    # message_content = f'R21/VSR0100/{this_filename} has finished.\n' + run_result
    # Telegrammer.send_message(message_content, chat_names=['Kapil'])
# make a listof all english alphabet letters

# make a list of all the numbers from 0 to 9